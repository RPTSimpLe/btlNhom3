...
@section("page")
    <form action="/admins/admin/createTeacher" method="post" enctype="multipart/form-data" class="form-horizontal">
        @csrf
        ...
        <div class="row form-group">
            <div class="col-3 col-md-3"><label for="text-input" class=" form-control-label">Học vấn: </label></div>
            <div class="col-12 col-md-9">
                <input type="text" id="text-input" placeholder="Nhập học vấn" class="form-control" name="education">
                @error('education')
                <small class="form-text">{{ $message }}</small>
                @enderror
            </div>
        ...
        <div class="row form-group d-none">
            <div class="col-12 col-md-9">
                <input type="text" id="text-input" name="role" value="teacher" class="form-control">
            </div>
        </div>
        <div class="row form-group">
